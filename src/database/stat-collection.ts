import { Guild, Message, MessageReaction, PartialMessageReaction, PartialUser, User } from 'discord.js';
...
export class StatCollection {
	...
	addReaction(messageReaction: MessageReaction | PartialMessageReaction, user: User | PartialUser): void {
